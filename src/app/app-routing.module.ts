...
const appRoutes: Routes = [
  ...
  { path : 'th-fonct' , component : ThFonctionsComponent, canActivate : [RoleGuard],data: {roles :["A"]}},
  { path : 'th-org', component : ThOrganisationsComponent,canActivate: [RoleGuard],data: {roles :["OM"]} },
  { path : 'th-groupes' , component : ThGroupesComponent, canActivate : [RoleGuard],data: {roles :["A"]}}, 
